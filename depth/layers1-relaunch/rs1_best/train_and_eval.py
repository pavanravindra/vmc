...
wavefunction = TestWavefunction(
    spins=spins, dim=dim, lattice=lattice, kpoints=kpoints, hiddenFeatures=32, T=1
)
...
referenceParameters = wavefunctions.loadParameters(
    "/burg-archive/ccce/users/phr2114/vmc/depth/layers1/rs{}_best/parameters.msgpack".format(str(r_ws))
)
