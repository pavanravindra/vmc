...
wavefunction = TestWavefunction(
    spins=spins, dim=dim, lattice=lattice, kpoints=kpoints, hiddenFeatures=32, T=4
)
...
referenceParameters = wavefunctions.loadParameters(
    "/burg-archive/ccce/users/phr2114/vmc/depth/layers3-relaunch/rs{}_best/parameters.msgpack".format(str(r_ws))
)
