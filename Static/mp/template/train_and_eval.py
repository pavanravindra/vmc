...
uhfFilepath = "/burg-archive/ccce/users/phr2114/vmc/uhf/N{}_rs{}_k171/".format(
    N, int(r_ws)
)

kpoints = jnp.load(uhfFilepath + "kpoints.npy")
spinUpInit = jnp.load(uhfFilepath + "upCoeff.npy")
spinDownInit = jnp.load(uhfFilepath + "downCoeff.npy")

wavefunction = wavefunctions.LogUMPCY(
    spins, L, kpoints, spinUpInit, spinDownInit
)
