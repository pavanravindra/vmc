...
diagMatrix = np.eye(numKpoints, spins[1])
diagMatrix[spins[1]-1,spins[1]-1] = 0
diagMatrix[spins[1],spins[1]-1] = 1
...
tunedAs = wavefunctions.loadParameters(
    "../../CYJastrow/rs{}_best/parameters.msgpack".format(str(r_ws))
