...
diagonalMatrix = jnp.eye(numKpts, spins[0])
spinUpCoeff = diagonalMatrix + 5e-2 * jax.random.normal(up_rng, shape=(numKpts, spins[0]))
spinDownCoeff = diagonalMatrix + 5e-2 * jax.random.normal(down_rng, shape=(numKpts, spins[1]))
