...
wavefunction = TestWavefunction(
    spins=spins, dim=dim, lattice=lattice, kpoints=kpoints, hiddenFeatures=16
)
...
referenceParameters = wavefunctions.loadParameters(
    "/burg-archive/ccce/users/phr2114/vmc/width/one16/rs{}_best/parameters.msgpack".format(str(r_ws))
)
