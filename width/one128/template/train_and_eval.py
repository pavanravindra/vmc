...
wavefunction = TestWavefunction(
    spins=spins, dim=dim, lattice=lattice, kpoints=kpoints, hiddenFeatures=128
)
...
tunedAs = wavefunctions.loadParameters(
    "/burg-archive/ccce/users/phr2114/vmc/rat/CYJastrow/rs{}_best/parameters.msgpack".format(str(r_ws))
