...
module purge
module load anaconda/3-2023.09 cuda12.0/toolkit/12.0.1 cudnn8.6-cuda11.8/8.6.0.163

source ~/.bashrc

conda activate folx
~/.conda/envs/folx/bin/python -u train_and_eval.py
